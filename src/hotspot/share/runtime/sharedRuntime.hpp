...
class SharedRuntime: AllStatic {
 ...
 public:
  ...
  static void notify_jvmti_mount(oopDesc* vt, jboolean hide, JavaThread* current);
  static void notify_jvmti_unmount(oopDesc* vt, jboolean hide, JavaThread* current);
