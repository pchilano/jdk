...
public class StopThreadTest2 {
    ...
    void testStopAtEmptyTask() throws Exception {
        ...
        // initialized. Otherwise, if we throw at VirtualThreadStartEvent
        // init for example, and this test runs before testStopAtYield,
        // foo will never be called and the test will hang.
